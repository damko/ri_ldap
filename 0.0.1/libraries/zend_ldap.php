...
class Zend_Ldap
{
        ...
        $sort = null, $collectionClass = null, $sizelimit = 0, $timelimit = 0)
    {
         ...
         */
        require_once SPARKPATH.'ri_ldap/0.0.1/libraries/Collection/Iterator/Default.php';
    ...
    public function getRootDse()
    {
        if ($this->_rootDse === null) {
             ...
             */
            require_once SPARKPATH.'ri_ldap/0.0.1/libraries/Node/RootDse.php';
    ...
    public function getSchema()
    {
        if ($this->_schema === null) {
             ...
             * @see Zend_Ldap_Node_Schema
             */
            require_once SPARKPATH.'ri_ldap/0.0.1/libraries/Node/Schema.php';
