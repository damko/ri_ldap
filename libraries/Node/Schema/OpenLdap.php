 ...
 */
require_once SPARKPATH.'ri_ldap/0.0.1/libraries/Node/Schema/AttributeType/OpenLdap.php';
/**
 * @see Zend_Ldap_Node_Schema_ObjectClass_OpenLdap
 */
require_once SPARKPATH.'ri_ldap/0.0.1/libraries/Node/Schema/ObjectClass/OpenLdap.php';
