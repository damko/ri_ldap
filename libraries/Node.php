...
//http://framework.zend.com/svn/framework/standard/trunk/library/Zend/Ldap/
//http://sgehrig.wordpress.com/tag/zend_ldap/
//http://framework.zend.com/wiki/display/ZFPROP/Zend_Ldap+-+Extended+support+-+Stefan+Gehrig#Zend_Ldap-Extendedsupport-StefanGehrig-1.Overview

/**
 * @see Zend_Ldap
 */
require_once SPARKPATH.'ri_ldap/0.0.1/libraries/Zend_Ldap.php';
/**
...
class Zend_Ldap_Node extends Zend_Ldap_Node_Abstract implements Iterator, RecursiveIterator
{
    ...
    public function getLdap()
    {
        if ($this->_ldap === null) {
             ...
             */
            require_once SPARKPATH.'ri_ldap/0.0.1/libraries/Exception.php';
    ...
    */
    ...
    public function toLdif(array $options = array())
    {
         ...
         */
        require_once SPARKPATH.'ri_ldap/0.0.1/libraries/Ldif/Encoder.php';
    ...
    public function searchSubtree($filter, $scope = Zend_Ldap::SEARCH_SCOPE_SUB, $sort = null)
    {
         ...
         */
        require_once SPARKPATH.'ri_ldap/0.0.1/libraries/Node/Collection.php';
    ...
    public function getChildren()
    {
         ...
         */
        require_once SPARKPATH.'ri_ldap/0.0.1/libraries/Node/ChildrenIterator.php';
